			...
			function Elements:CreateDropdown(dName, list, callback)
				...
				DropDown.MouseButton1Click:Connect(function()
					if opened then
						...
						tween:Create(Down, tweeninfo(0.08, Enum.EasingStyle.Linear,Enum.EasingDirection.In), {
							ImageTransparency = 0
						}):Play()
